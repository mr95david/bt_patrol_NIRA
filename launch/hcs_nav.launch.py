...
def generate_launch_description():
    ...
    hcs_navigation = get_package_share_directory('hcs_navigation')

    # Obtencion de ruta de carpetas de paquete
    launch_path = os.path.join(hcs_navigation, 'launch')
    map_path = os.path.join(nav2_bringup, 'maps', 'turtlebot3_world.yaml')
    config_path = os.path.join(hcs_navigation, 'config', 'hcs_config.yaml')
